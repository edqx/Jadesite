    ...
    <div class="lg:ml-38 mb-42 relative flex flex-col">
        ...
        <div class="flex items-center flex-col xl:items-start xl:flex-row gap-16">
            <div class="mx-8 sm:mx-0 sm:w-[30rem]">
                ...
                <p>
                    To the right is some graphic design and photography work done for a project aiming to create a magazine front cover and double page spread. My designs were inspired by the photographer Liam Wong, specifically his "Harajuku Umbrellas" collection. Along with design work, there were also multiple 'story' based challenges to consider too, includng themeing for the photoshoot and what kind of text to create on the cover and pages. Though one of my earlier graphic design projects, I am still quite happy with how it turned out, it passed with top marks too, which is a nice bonus. Some clickable text to that leads to the google slides presentation is attached below in order to see some of the processes made to get me to those final designs. 
                    <br><br>
    ...
    <div class="lg:ml-38 mb-38 relative flex flex-col">
        ...
        <div class="flex items-center flex-col xl:items-start xl:flex-row gap-16">
            <div class="mx-8 sm:mx-0 sm:w-[30rem]">
                ...
                <p>
                    To the right is both graphic design, photography and videography work done for an advertisement project with the goal of creating visual media promoting 4 films/shows of different genres for Netflix. At least 3 of whch had to be unique media styles ("exclusively graphic design", "including photography", "including videography") with the fourth being up to me. As it may be obvious, I prefer my work to be more minimalist and sleek, coveying just enough information as needed, whilst still peaking interest. Looking back on this project I don't think the designs are as good as they could have been, however I am again still quite happy with them, they too passed with top marks. As with the project above, a clickable link the google sldies presentation is given below in order to see some design process and research.
                    <br><br>
